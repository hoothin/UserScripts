        ...
        var siteInfo=[
            ...
            {name:"百度贴吧",
             ...
             getImage:function(img){
                 ...
                 var portrait=/himg.baidu.com\/sys\/portrait/;
                 var result=src.match(reg);
                 //帖子列表页面
                 if(portrait.test(src)){
                     return src.replace(/himg.baidu.com\/sys\/portrait/,"himg.baidu.com/sys/portraitl");
            ...
            {name:"bilibili",
             ...
             getImage:function(img){
                 var oldsrc=this.src;
                 var pic=/\d+_\d+\/|\d+_x\d+\.jpg$|@\d+w_\d+h\.webp$/i;
                 var newsrc;
                 if(pic.test(oldsrc)){
            ...
            {name: '知乎',
             url: /zhihu\.com/,
             getImage: function() {
                 return this.src.replace(/_(b|s|\d+x\d+)\./,".");
             }
            }
        ];
