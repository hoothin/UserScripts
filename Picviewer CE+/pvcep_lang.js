...
}, 
{
    ...
    lang: {
        ...
        saveBtn: "حفظ",
        saveName: "حفظ الاسم",
        saveNameTip: "احفظ الصور بالاسم",
        aria2Host: "خادم Aria2",
        aria2Token: "رمز Aria2",
        post2Aria2: "النشر إلى aria2",
        default: "افتراضي",
        textFirst: "المعلومات أولاً إذا كانت موجودة",
        onlyUrl: "فقط مع الرابط",
        urlAndText: "الرابط + المعلومات",
        download: "تنزيل",
        saveBtnTips: "بعض الخيارات تحتاج إلى تحديث الصفحة لتطبيقها",
        additionalFeature: "ميزة إضافية، تأخذ تأثير عند الضغط على مفتاح Alt",
        invertAdditionalFeature: "عكس مفاتيح الاختصار، استخدم الميزات الإضافية افتراضيًا",
        copy: "نسخ الرابط",
        copyImg: "نسخ بيانات الصورة",
        openInNewTab: "فتح في علامة تبويب جديدة",
        closeBtn: "إلغاء",
        invertBtn: "عكس",
        compareBtn: "مقارنة",
        selectAllBtn: "تحديد الكل",
        closeBtnTips: "إلغاء هذا الإعداد واستعادة جميع الخيارات",
        resetLink: "استعادة الإعدادات الافتراضية",
        resetLinkTips: "استعادة جميع الإعدادات إلى القيم الافتراضية",
        share: "مشاركة",
        suitLongImg: "تناسب الصور الطويلة في نافذة التمرير",
        globalkeys: "المفاتيح العامة للمعاينة: ",
        globalkeysPress: "اضغط لتبديل المعاينة",
        globalkeysHold: "اضغط مع الاستمرار لتمكين المعاينة",
        globalkeysType: "طريقة تمكين المعاينة",
        closeAfterPreview: "إغلاق نافذة الصورة بعد المعاينة",
        previewMaxSize: "الحجم الأقصى لنافذة المعاينة",
        previewMaxSizeTip: "عندما تكون نافذة المعاينة أكبر من الحجم المحدد، قم بتقليص نافذة المعاينة. 0 = معطل",
        loadAll: "تحميل المزيد من الصفحات",
        loadedAll: "تم التحميل",
        loading: "جارٍ التحميل ...",
        loadAllTip: "تحميل الصورة في الصفحة التالية",
        viewmoreEndless: "تحميل المزيد من الصور عند التمرير إلى الأسفل",
        fiddle: "تشغيل",
        fiddleTip: "ظهور الصور للعمليات المعقدة",
        addImageUrls: "إضافة صورة",
        addImageUrlsTips: "إضافة المزيد من الصور عبر الرابط",
        openImages: "صورة محلية",
        openImagesTips: "انقر لاستيراد الصور المحلية",
        closeFirst: "أغلق المعرض الحالي أولاً",
        collect: "مجموعة",
        collected: "تم الجمع",
        exitCollection: "الخروج من المجموعة",
        exitCollectionTip: "انقر للخروج من وضع المجموعة",
        noCollectionYet: "ليس لديك أي صورة في المجموعة",
        collectDetail: "وصف",
        collectDetailTip: "أضف بعض الأوصاف إلى صورك المفضلة",
        playSlide: "تشغيل الشرائح",
        slideGap: "الفاصل (ثواني)",
        slideGapTip: "الفاصل، وحدة (ثواني)",
        slideBack: "رجوع",
        slideBackTip: "التشغيل من الخلف إلى الأمام",
        slideRandom: "Random",
        slideWait: "انتظر قراءة الصورة",
        slideWaitTip: "يبدأ العد التنازلي بعد قراءة كل صورة بالكامل.",
        slideSkipError: "تخطي الصور الخاطئة",
        slideSkipErrorTip: "تخطي الصور الخاطئة بسرعة",
        type: "الفئة",
        typeTip: "اختر فئة الصورة",
        showWithRules: "إظهار الأيقونة بالقواعد",
        showWithRulesTip: "عرض الأيقونة إذا كانت الصورة تتطابق مع القواعد بغض النظر عن حجمها",
        advancedRules: "القواعد المتقدمة",
        advancedRulesTip: "مطابقة بالقواعد المتقدمة",
        tpRules: "قواعد البدل",
        tpRulesTip: "مطابقة بقواعد البدل",
        scaleRules: "مكبرة",
        scaleRulesTip: "الصورة التي تم العثور عليها تلقائيًا ولكن تم تكبيرها",
        noScaleRules: "بدون تكبير",
        noScaleRulesTip: "الصورة التي تم العثور عليها تلقائيًا ولكن بدون تكبير",
        smallRules: "حجم صغير",
        smallRulesTip: "بكسل #t# صورة صغيرة الحجم، الحجم الفعلي للارتفاع والعرض أقل من",
        lockSizeTip: "قفل الحجم الأقصى",
        command: "أمر",
        commandTip: "قائمة الأوامر",
        onlineEdit: "تحرير عبر الإنترنت",
        onlineEditTip: "#t# تحرير هذه الصورة عبر الإنترنت باستخدام",
        openInNewWindow: "فتح في نافذة جديدة",
        openInNewWindowTip: "فتح الصورة في نافذة جديدة",
        findInPage: "بحث في الصفحة",
        findInPageTip: "التمرير إلى الصورة الحالية في الصفحة",
        viewCollection: "عرض المجموعة",
        viewCollectionTip: "عرض جميع الصور المجمعة",
        inCollection: "غير قادر على الاستخدام في وضع المجموعة",
        cantFind: "الصورة ليست في الوثيقة، أو مخفية ولا يمكن العثور عليها!",
        exportImages: "تصدير جميع الصور",
        exportImagesTip: "تصدير جميع الصور الكبيرة المعروضة إلى نافذة جديدة",
        downloadImage: "تنزيل جميع المعروض",
        downloadImageTip: "تنزيل الصور الحالية المعروضة",
        copyImagesUrl: "نسخ روابط جميع الصور",
        copyImagesUrlTip: "نسخ روابط جميع الصور الكبيرة المعروضة",
        copySuccess: "تم نسخ #t# روابط بنجاح",
        autoRefresh: "تحميل الصفحة تلقائيًا",
        autoRefreshTip: "عند عرض الصور القليلة الأخيرة، قم بالتمرير إلى الأسفل، بحيث تقوم بعض صفحات الويب بتحميل الصور الجديدة",
        enterFullsc: "دخول ملء الشاشة",
        exitFullsc: "خروج من ملء الشاشة",
        config: "الإعدادات",
        openConfig: "فتح الإعدادات",
        ruleRequest: "طلب القواعد",
        closeGallery: "إغلاق المعرض",
        returnToGallery: "العودة إلى المعرض",
        picInfo: "انقر لتغيير",
        picNote: "تعليق الصورة",
        urlFilter: "مرشح الرابط",
        urlFilterTip: "أدخل كلمات رئيسية أو تعبيرات منتظمة لتصفية الروابط",
        resolution: "دقة الصورة",
        picNum: "عدد الصور",
        picTips: "CTRL عرض الصور باستخدام",
        savePageTips: "احفظ هذه الصفحة لتنزيل جميع الصور",
        scaleRatio: "نسبة التكبير",
        similarImage: "البحث بالصورة",
        scale: "تكبير",
        horizontalFlip: "انعكاس أفقي",
        verticalFlip: "انعكاس عمودي",
        actualBtn: "عرض الأصلي (A)",
        searchBtn: "البحث عن الصورة الأصلية (S)",
        galleryBtn: "عرض المعرض (G)",
        currentBtn: "عرض الحالية (C)",
        magnifierBtn: "مكبر/تكبير (M)",
        picTitle: "عنوان الصورة",
        exportImagesUrl: "تصدير روابط الصور",
        exportImagesUrlPop: "Ctrl+C لنسخ روابط الصور",
        beginSearchImg: "#t# البدء في البحث عن الصورة ...",
        findNoPic: "لم يتم العثور على الصورة الأصلية",
        findOverBeginLoad: "#t# نهاية الخريطة، العثور على #t# صور متطابقة، بدء تحميل الأولى",
        loadNextSimilar: "فشل تحميل الصورة الأصلية، حاول تحميل النتيجة التالية...",
        loadError: "فشل التحميل",
        openHomePage: "فتح الصفحة الرئيسية",
        position: "وضع العرض",
        positionTips: "لإخفاء ALT اضغط مع الاستمرار على",
        topLeft: "الزاوية العلوية اليسرى من الصورة",
        topRight: "الزاوية العلوية اليمنى من الصورة",
        bottomRight: "الزاوية السفلية اليمنى من الصورة",
        bottomLeft: "الزاوية السفلية اليسرى من الصورة",
        topCenter: "بجانب الصورة",
        bottomCenter: "أسفل الصورة",
        floatBar: "شريط الأدوات",
        previewFollowMouse: "عرض المعاينة بجانب الفأرة",
        showDelay: "تأخير العرض",
        ms: "مللي ثانية",
        hide: "إخفاء",
        hideDelay: "تأخير الإخفاء",
        forceShow: "عرض شريط الأدوات فوق الصورة غير المكبرة التي تتجاوز هذا الحجم،",
        forceShowTip: "عرض شريط الأدوات العائم عندما يتجاوز حجم الصورة غير المكبرة الحجم المحدد أدناه",
        sizeLimitOr: "فعال بالطول أو العرض فقط",
        px: "بكسل",
        minSizeLimit: "عرض شريط الأدوات فوق الصورة المكبرة التي تتجاوز هذا الحجم",
        minSizeLimitTip: "بعد تكبير الصورة (لا يتطابق الحجم الأصلي للصورة مع الحجم الفعلي)، يتم عرض شريط الأدوات العائم عندما يكون طول الصورة المعروضة أكبر من القيمة المحددة.",
        defaultSizeLimit: "حد الحجم الافتراضي للمعرض",
        listenBg: "استماع لصورة الخلفية",
        backgroundColor: "لون الخلفية",
        listenBgTip: "عرض شريط الأدوات على العنصر الذي يحتوي على صورة خلفية",
        butonOrder: "ترتيب رموز شريط الأدوات",
        keysEnable: "تمكين الاختصارات",
        keysActual: "فتح الصورة الكبيرة",
        keysActualTip: "اضغط على هذا الزر لفتح صورة كبيرة عندما يظهر شريط الأدوات العائم",
        keysSearch: "البحث عن الصورة الأصلية",
        keysSearchTip: "اضغط على هذا الزر للبحث عن الصورة الأصلية عندما يظهر شريط الأدوات العائم",
        headSearchTip: "البحث بالصورة",
        headSearchAll: "البحث في الكل",
        keysCurrent: "فتح الصورة الحالية",
        keysCurrentTip: "اضغط على هذا الزر لفتح الصورة الحالية عندما يظهر شريط الأدوات العائم",
        keysMagnifier: "فتح المكبر للمراقبة",
        keysMagnifierTip: "اضغط على هذا الزر لفتح المكبر عندما يظهر شريط الأدوات العائم",
        keysGallery: "فتح المعرض (عالمي مع مفاتيح الوظائف)",
        keysGalleryTip: "اضغط على هذا الزر لفتح المعرض عندما يظهر شريط الأدوات العائم",
        openGallery: "فتح المعرض",
        magnifier: "تكبير",
        magnifierRadius: "نصف القطر الافتراضي",
        magnifierWheelZoomEnabled: "تمكين تكبير العجلة",
        magnifierWheelZoomRange: "نسبة التكبير للمكبر",
        magnifierScaleImage: "تكبير الصورة بالعجلة",
        gallery: "المعرض",
        galleryFitToScreen: "تكبير الصورة لتناسب الشاشة",
        galleryFitToScreenSmall: "تكبير الصورة الصغيرة أيضًا",
        galleryFitToScreenTip: "التكيف ليكون يحتوي، وليس يغطي",
        galleryScrollEndToChange: "تبديل الصورة بعد التمرير إلى نهاية الصورة الطويلة",
        galleryScrollEndToChangeTip: "فعال بعد إلغاء الخيار السابق",
        galleryExportType: "الترتيب الافتراضي عند تصدير الصور",
        grid: "ترتيب البلاط",
        gridBig: "الترتيب الأصلي",
        list: "ترتيب القائمة",
        galleryAutoLoad: "تحميل المزيد من الصور تلقائيًا في الصفحة التالية",
        galleryLoadAll: "معالجة جميع الصفحات تلقائيًا عند تحميل المزيد من الصور",
        galleryLoadAllTip: "قد تؤثر الصفحات الكثيرة على التجربة",
        galleryDownloadWithZip: "ضغط إلى ZIP عند تنزيل الكل",
        galleryDownloadWithZipAlert: "جارٍ الضغط، يرجى الانتظار قليلاً",
        galleryScaleSmallSize1: "الحجم الفعلي أقل من الارتفاع والعرض",
        galleryScaleSmallSize2: "البكسلات مصنفة كصور صغيرة الحجم",
        galleryShowSmallSize: "عرض الصور الصغيرة افتراضيًا",
        galleryTransition: "عرض التأثيرات عند التبديل بين الصور في المعرض",
        gallerySidebarPosition: "وضع شريط الصور المصغرة",
        bottom: "الأسفل",
        right: "اليمين",
        left: "اليسار",
        top: "الأعلى",
        gallerySidebarSize: "الارتفاع",
        gallerySidebarSizeTip: "ارتفاع شريط الصور المصغرة (إذا كان أفقيًا) أو العرض (إذا كان رأسيًا)",
        galleryMax1: "التحميل المسبق الأقصى",
        galleryMax2: "الصور (قبل وبعد)",
        galleryAutoZoom: "التكبير يعود إلى 100% (كروم)",
        galleryAutoZoomTip: "إذا قمت بالتكبير، قم بتغيير تكبير الصورة وأجزاء شريط الصور المصغرة إلى 100% وزيادة المساحة القابلة للعرض (صالح فقط في كروم)",
        galleryDescriptionLength1: "الحد الأقصى للتعليق هو",
        galleryDescriptionLength2: "الأحرف",
        galleryAutoOpenSites: "عناوين المواقع لفتح المعرض تلقائيًا، واحد في كل سطر، يبدأ بـ @ لعرض المزيد",
        autoOpenViewmore: "عرض المزيد تلقائيًا عند فتح المعرض",
        gallerySearchData: "قواعد المواقع للبحث، أفرغها لاستعادة",
        galleryEditSite: "تحرير الموقع عبر الإنترنت",
        imgWindow: "نافذة الصورة",
        imgWindowFitToScreen: "التكيف مع الشاشة",
        imgWindowFitToScreenTip: "التكيف ليكون يحتوي، وليس يغطي",
        imgWindowFitToScreenWhenSmall: "التكيف مع الشاشة حتى وإن كانت صغيرة",
        imgWindowDefaultTool: "الأداة المختارة افتراضيًا عند فتح النافذة",
        hand: "اليد",
        rotate: "تدوير",
        zoom: "مكبر",
        imgWindowEscKey: "Esc ، للإغلاق",
        imgWindowDblClickImgWindow: "النقر المزدوج للإغلاق",
        imgWindowClickOutside: "النقر خارج النافذة للإغلاق",
        imgWindowClickOutsideTip: "فعالة فقط عند عرض الطبقة الزائدة",
        none: "لا شيء",
        click: "نقرة",
        dblclick: "نقرة مزدوجة",
        imgWindowOverlayerShown: "الطبقة الزائدة",
        imgWindowOverlayerColor: "اللون والعتامة",
        imgWindowShiftRotateStep1: "Shift تدوير للكل عند الضغط على",
        imgWindowShiftRotateStep2: "درجة",
        imgWindowMouseWheelZoom: "تكبير باستخدام عجلة الفأرة",
        imgWindowZoomRange: "نطاق التكبير",
        imgWindowZoomRangeTip: "نسبة التكبير (يجب أن تكون موجبة)",
        others: "أخرى",
        waitImgLoad: "البدء في تنفيذ العمليات مثل التكبير حتى يتم تحميل الصورة",
        waitImgLoadTip: "يمكنك مؤقتًا تنفيذ العكس لهذا الإعداد ،Ctrl عند الضغط مع الاستمرار على",
        debug: "وضع التصحيح",
        customRules: "القواعد المخصصة للصورة الكبيرة",
        firstEngine: "محرك البحث المفضل (الأول)",
        refreshWhenError: "خطأ في القراءة، انقر لإعادة التحميل",
        switchSlide: "تبديل الشريط الجانبي",
        viewmore: "عرض المزيد",
        countDown: "العد التنازلي",
        customLang: "اللغة المخصصة",
        defaultLang: "الكشف التلقائي",
        hideIcon: "إخفاء الأيقونة",
        initShow: "عكس الاختصار لعرض المعاينة افتراضيًا",
        stayOut: "دع شريط الأدوات العائم يبقى خارج الصورة",
        galleryDownloadGap: "الفاصل الزمني للتنزيل",
        formatConversion: "تحويل تنسيق الصورة عند التنزيل. قاعدة واحدة في كل سطر",
        galleryDisableArrow: "تعطيل مفتاح السهم",
        positionFixed: "موضع ثابت",
        switchStoreLoc: "الاحتفاظ بموقع الذاكرة أثناء التبديل"
    }
},
{
    name: "简体中文",
