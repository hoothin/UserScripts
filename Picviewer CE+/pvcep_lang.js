...
},
{
    ...
    lang: {
        ...
        closeAfterPreview:"закрыть окно изображения после просмотра",
        ...
        addImageUrls:"Добавить картинку",
        addImageUrlsTips:"Добавьте больше изображений через URL",
        ...
        showWithRules:"Принудительно показывать значок с правилом",
        showWithRulesTip:"Показывать значок, если изображение соответствует правилам, независимо от его размера",
        ...
        previewFollowMouse:"Показывать превью рядом с мышью",
        ...
        imgWindowFitToScreenWhenSmall:"Адаптируйтесь к экрану, даже если он маленький",
