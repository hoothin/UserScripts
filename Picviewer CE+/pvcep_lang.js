...
var ptLang={
    ...
    downloadImageTip:"Baixar as imagens exibidas atualmente, sem suporte à origem cruzada",
...
var ruLang={
    ...
    saveBtn: "ОК",
    download: "Скачать",
    saveBtnTips: "Некоторые параметры требуют обновления страницы, для их вступления в силу",
    closeBtn: "Отмена",
    invertBtn: "Инвертировать",
    closeBtnTips: "Отменить эту настройку и восстановить все параметры",
    resetLink: "Восстановить настройки по умолчанию",
    resetLinkTips: "Восстановить все настройки до значений по умолчанию",
    share: "Поделиться",
    suitLongImg: "Длинное изображение отображается в прокручиваемом окне",
    globalkeys: "Глобальные клавиши для предварительного просмотра: ",
    globalkeysPress: "Нажмите, чтобы включить предварительный просмотр",
    globalkeysHold: "Удерживайте, чтобы включить предварительный просмотр",
    globalkeysType: "Способ включения предпросмотра",
    loadAll: "Загрузить больше страниц",
    loadedAll: "Загрузка завершена",
    loading: "Загрузка...",
    loadAllTip: "Загрузить картинку на следующей странице",
    viewmoreEndless: "Загрузить больше фото. Прокрутите до конца, чтобы автоматически загрузить следующую страницу",
    fiddle: "Действия",
    fiddleTip: "Всплывающее окно для сложных действий (Вращение, Зум, Вертикальное/Горизонтальное отражение)",
    closeFirst: "Сначала закройте текущую открытую галерею",
    collect: "Коллекция",
    collected: "В коллекции",
    exitCollection: "Выйти из коллекции",
    exitCollectionTip: "Нажмите, чтобы выйти из режима коллекции",
    noCollectionYet: "У вас нет ни одного изображения в коллекции",
    collectDetail: "Описание",
    collectDetailTip: "Добавьте описания к вашим любимым изображениям",
    playSlide: "Запустить слайд-шоу",
    slideGap: "Интервал (секунд)",
    slideGapTip: "Интервал (секунд)",
    slideBack: "Назад",
    slideBackTip: "Воспроизведение в обратном порядке",
    slideWait: "Ждать прогрузки изображения",
    slideWaitTip: "Обратный отсчёт начинается после того, как каждое изображение будет полностью прогружено",
    slideSkipError: "Пропускать ошибочные изображения",
    slideSkipErrorTip: "Быстро пропустить чтение ошибочных изображений",
    type: "Категория",
    ...
    tpRules: "Подстановочные правила",
    tpRulesTip: "Соответствует правилам с подстановочными знаками",
    scaleRules: "Увеличено",
    scaleRulesTip: "Изображение, найденное автоматически, но масштабированное",
    noScaleRules: "Без масштабирования",
    noScaleRulesTip: "Изображение, найденное автоматически, но без масштабирования",
    smallRules: "Маленький размер",
    smallRulesTip: "Изображение небольшого размера, реальный размер по высоте и ширине меньше #t# пикселей",
    lockSizeTip: "Зафиксировать максимальный размер",
    command: "Команды",
    commandTip: "Меню Команд",
    onlineEdit: "Онлайн-редактирование",
    onlineEditTip: "Редактировать это изображение онлайн с помощью #t#",
    openInNewWindow: "Открыть в новом окне",
    openInNewWindowTip: "Открыть изображение в новом окне",
    findInPage: "Найти на странице",
    findInPageTip: "Перейти к текущему изображению на странице",
    viewCollection: "Просмотреть коллекцию",
    viewCollectionTip: "Просмотреть все собранные изображения",
    inCollection: "Невозможно использовать в режиме коллекции",
    cantFind: "Изображения нет в документе, либо оно скрыто и не может быть найдено",
    exportImages: "Экспортировать все изображения",
    exportImagesTip: "Экспортировать все отображаемые изображения большого размера в новое окно",
    downloadImage: "Загрузить всё показанное",
    downloadImageTip: "Загрузить все отображаемые изображения в текущей библиотеке, обратите внимание, что междоменные изображения не могут быть загружены",
    copyImagesUrl: "Копировать URL всех изображений",
    copyImagesUrlTip: "Копировать все отображаемые URL-адреса изображений большого размера",
    copySuccess: "Успешно скопировано #t# ссылок",
    autoRefresh: "Автоматическая перезагрузка",
    autoRefreshTip: "Когда будут просмотрены последние несколько изображений, прокрутите главное окно вниз, чтобы вёб-страница загрузила новые изображения",
    ...
    picInfo: "Информация об изображении",
    picNote: "Аннотация изображения. Нажмите, чтобы изменить",
    urlFilter: "Url-фильтр",
    urlFilterTip: "Введите ключевые слова или Regexp для фильтрации Url-ов",
    resolution: "Разрешение изображения",
    picNum: "Количество картинок",
    picTips: "Просмотр изображений с помощью клавиши CTRL",
    savePageTips: "Сохраните эту страницу, чтобы загрузить все фото",
    ...
    actualBtn: "Просмотреть оригинал (A)",
    searchBtn: "Найти исходное изображение (S)",
    galleryBtn: "Просмотреть галерею (G)",
    currentBtn: "Просмотреть текущее изображение (C)",
    magnifierBtn: "Лупа / ZooM (M)",
    picTitle: "Название изображения",
    exportImagesUrl: "Скопировать ссылку на изображение",
    exportImagesUrlPop: "Ctrl+C, чтобы скопировать URL-адрес изображения",
    beginSearchImg: "#t# начат поиск изображений ...",
    findNoPic: "Исходное изображение не найдено",
    findOverBeginLoad: "Поиск изображений завершён, всего найдено #t# изображений. Загружено первое изображение",
    loadNextSimilar: "Не удалось загрузить исходное изображение, попробуйте загрузить следующий результат...",
    loadError: "Загрузка не удалась",
    openHomePage: "Открыть домашнюю страницу",
    position: "Показать позицию",
    positionTips: "Удерживайте ALT, чтобы скрыть",
    topLeft: "Левый верхний угол изображения",
    topRight: "Правый верхний угол изображения",
    bottomRight: "Правый нижний угол изображения",
    bottomLeft: "Нижний левый угол изображения",
    topCenter: "Рядом с (/над) картинкой",
    bottomCenter: "Под картинкой",
    floatBar: "Плавающая панель инструментов",
    showDelay: "Задержка показа",
    ms: "мс",
    hide: "Скрыть",
    hideDelay: "Задержка скрытия",
    forceShow: "Показывать панель инструментов поверх немасштабированного изображения сверх этого размера, ",
    ...
    sizeLimitOr: "Зависит только от высоты ИЛИ ширины",
    px: "пикселей",
    minSizeLimit: "Показывать панель инструментов над увеличенным изображением сверх этого размера",
    minSizeLimitTip: "После масштабирования изображения (исходный размер изображения не соответствует фактическому размеру) плавающая панель инструментов будет отображаться, когда отображаемая длина и ширина исходного изображения превышают установленное значение.",
    defaultSizeLimit: "Ограничение размера галереи по умолчанию",
    listenBg: "Прослушивание фонового изображения",
    ...
    keysActual: "Открыть большую картинку",
    keysActualTip: "Нажмите эту кнопку, чтобы открыть большое изображение, когда появится плавающая панель",
    keysSearch: "Найти исходное изображение",
    keysSearchTip: "Нажмите эту кнопку, чтобы найти исходное изображение, когда появится плавающая панель",
    headSearchTip: "Поиск по изображению",
    headSearchAll: "• Искать во всех ↑",
    keysCurrent: "Открыть текущую картинку",
    keysCurrentTip: "Нажмите эту кнопку, чтобы открыть текущее изображение, когда появится плавающая панель",
    keysMagnifier: "Откройте лупу для наблюдения",
    keysMagnifierTip: "Нажмите эту кнопку, чтобы открыть лупу, когда появится плавающая панель",
    keysGallery: "Открыть галерею (глобально с функциональными клавишами)",
    keysGalleryTip: "Нажмите эту кнопку, чтобы открыть галерею, когда появится плавающая панель",
    openGallery: "Открыть галерею",
    magnifier: "Лупа / ZooM",
    magnifierRadius: "Радиус по умолчанию",
    magnifierWheelZoomEnabled: "Включить масштабирование колёсиком мыши",
    magnifierWheelZoomRange: "Коэффициент масштабирования для лупы, колёсиком мыши",
    gallery: "Галерея",
    galleryFitToScreen: "Масштабировать изображение по размеру экрана",
    galleryFitToScreenSmall: "Маленькие изображения также масштабируются по размеру экрана",
    galleryFitToScreenTip: "Подогнать картинку по горизонтали или вертикали, чтобы большая картинка показывалась целиком",
    galleryScrollEndToChange: "Переключить изображение после того, как длинное изображение прокрутится до конца",
    galleryScrollEndToChangeTip: "Действительно после отмены предыдущей опции",
    galleryExportType: "Сортировка по умолчанию при экспорте изображений",
    grid: "Мозаичная сортировка",
    gridBig: "Плитка исходного изображения",
    list: "Сортировка списком",
    galleryAutoLoad: "Автоматически загружать больше изображений на следующей странице",
    galleryLoadAll: "Автоматически обрабатывать все страницы при загрузке большего количества изображений",
    galleryLoadAllTip: "Если страниц слишком много, это может повлиять на производительность",
    galleryDownloadWithZip: "Сжимать в ZIP при скачивании всего",
    galleryDownloadWithZipAlert: "Сжатие в ZIP... Подождите, пожалуйста",
    galleryScaleSmallSize1: "При реальных размерах по высоте и ширине меньше ",
    galleryScaleSmallSize2: " пикселей, картинки классифицируются как изображения небольшого размера (маленькие)",
    galleryShowSmallSize: "По умолчанию показывать маленькие картинки",
    galleryTransition: "Показывать специальные эффекты при переключении картинок в галерее",
    gallerySidebarPosition: "Положение панели эскизов",
    bottom: "Cнизу",
    right: "Справа",
    left: "Слева",
    top: "Сверху",
    gallerySidebarSize: "Высота",
    gallerySidebarSizeTip: "Высота панели эскизов (если она горизонтальная) или ширина (если она вертикальная)",
    galleryMax1: "Максимальная предварительная выборка",
    galleryMax2: " фото (до и после)",
    galleryAutoZoom: "Авто-Масштаб к 100%",
    galleryAutoZoomTip: "Если есть масштабирование, изменит масштаб изображения и разделов боковой панели обратно на 100 % и увеличит видимую область (работает только в Chrome)",
    galleryDescriptionLength1: "Максимальная длина аннотации",
    galleryDescriptionLength2: " символов",
    galleryAutoOpenSites: "Обычные URL-адреса для автоматического открытия галереи, по одному в строке. Если вы добавите @ в начале, галерея будет автоматически расширена",
    autoOpenViewmore: "Автоматически просматривать дальше при открытии галереи",
    galleryViewmoreLayout:"Расположение режима просмотра ",
    gallerySearchData: "Правила для поиска по картинке, очистить для восстановления дефолтных",
    galleryEditSite: "Сайт для редактирования онлайн",
    imgWindow: "Окно изображения",
    imgWindowFitToScreen: "Подогнать к размерам экрана",
    imgWindowFitToScreenTip: "Подогнать картинку по горизонтали или вертикали, чтобы большая картинка показывалась целиком",
    imgWindowDefaultTool: "Инструмент, выбранный по умолчанию при открытии окна",
    hand: "Хваталка",
    rotate: "Повернуть",
    zoom: "Лупа / ZooM",
    imgWindowEscKey: "Нажмите Esc для закрытия",
    imgWindowDblClickImgWindow: "Дважды кликните, чтобы закрыть",
    imgWindowClickOutside: "Кликните за пределами изображения (оверлея), чтобы закрыть его",
    imgWindowClickOutsideTip: "Вступает в силу только при отображении оверлея",
    none: "Нет",
    click: "Одиночный клик",
    dblclick: "Двойной клик",
    imgWindowOverlayerShown: "Наложение",
    imgWindowOverlayerColor: "Цвет и непрозрачность",
    imgWindowShiftRotateStep1: "При вращении удерживайте клавишу Shift, чтобы повернуть на шаг в",
    imgWindowShiftRotateStep2: "градусов",
    imgWindowMouseWheelZoom: "Масштабирование колёсиком мыши",
    imgWindowZoomRange: "Коэффициент масштабирования колёсиком мыши",
    imgWindowZoomRangeTip: "Коэффициент масштабирования (должен быть положительным)",
    others: "Другое",
    waitImgLoad: "Ждать, пока изображение полностью загрузится, прежде чем начинать выполнять такие операции, как масштабирование",
    waitImgLoadTip: "Удерживая клавишу Ctrl, вы можете временно выполнить противоположное этому параметру действие",
    debug: "Режим отладки",
    customRules: "Пользовательские правила для больших изображений",
    firstEngine: "Предпочтительная (первая) поисковая система",
    refreshWhenError: "Ошибка чтения, нажмите, чтобы перечитать",
