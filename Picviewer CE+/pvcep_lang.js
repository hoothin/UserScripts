...
},
{
    ...
    lang: {
        ...
        textFirst: "Опис зображення",
        onlyUrl: "Тільки ім'я файла у посиланні",
        urlAndText: "Посилання + опис файлу",
        download:"Завантажити",
        download2copy: "Використовувати копіювання замість завантаження",
        ...
        resetLink:"Відновити за замовчуванням",
        ...
        closeAfterPreview:"Закривати вікно зображення, коли попередній перегляд завершується",
        loadAll:"Завантажувати більше сторінок",
        ...
        showWithRules:"Відображається відповідно до правил",
        showWithRulesTip:"Якщо правило дотримано, іконка буде відображатись незалежно від розміру",
        ...
        autoRefresh:"Автоперезавантаження",
        ...
        config:"Налаштування",
        openConfig:"Відкриває налаштування",
        ...
        position:"Показати розташування",
        ...
        previewFollowMouse:"Змусити попередній перегляд слідувати за вказівником миші",
        showDelay:"Затримка до відображення",
        ms:"мс.",
        hide:"Приховати",
        hideDelay:"Затримка до приховування",
        forceShow:"Зображення без масштабування, що перевищують цей розмір, відображають плаваючу панель",
        forceShowTip:"Відобразити плаваючу панель, коли розмір немасштабованого зображення перевищує розмір, встановлений нижче",
        sizeLimitOr:"Має бути дотримана тільки одна з вищевказаних умов довжини і ширини",
        px:"пікс.",
        ...
        keysEnable:"Ввімкнути наступну комбінацію клавіш",
        ...
        headSearchAll:"Виконуйте пошук по всьому перерахованому вище",
        ...
        galleryExportType:"Експорт сортування зображень за замовчуванням",
        grid:'Сітка',
        ...
        galleryDownloadWithZip:"Завантажувати все в zip-архіві",
        ...
        galleryTransition:"Відображати ефекти перемикання зображень в галереї",
        ...
        galleryAutoZoom:"Повернути масштаб на 100% (chrome)",
        galleryAutoZoomTip:"Якщо є збільшення, змініть масштаб зображення і бічної панелі назад на 100%, щоб збільшити візуальну область (допустимо тільки в Chrome)",
        ...
        imgWindowShiftRotateStep1:"При обертанні утримуйте Shift і обертайте з кроком у",
        ...
        initShow:"Інвертувати поєднання клавіш, попередній перегляд відображається за замовчуванням",
