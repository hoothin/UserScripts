...
(function() {
    ...
    const langData = [
        ...
        {
            name: "العربية",
            match: ["ar", "ar-SA", "ar-EG", "ar-AE", "ar-MA", "ar-DZ", "ar-TN", "ar-IQ", "ar-JO", "ar-LB", "ar-KW", "ar-OM", "ar-QA", "ar-BH", "ar-SY", "ar-YE", "ar-LY", "ar-SD"],
            lang: {
                enableDebug: "تفعيل مخرجات تصحيح الأخطاء (Debug) في وحدة التحكم",
                updateNotification: "إرسال إشعار بعد تحديث القواعد",
                disable: "تعطيل مؤقت",
                disableSite: "تفعيل / تعطيل في هذا الموقع",
                disableSiteTips: "معطل في هذا الموقع.",
                enableSiteTips: "مفعل في هذا الموقع.",
                enable: "✅ تفعيل التمرير التلقائي للصفحات",
                tempActive: "مفعل مؤقتاً",
                toTop: "العودة للأعلى.",
                toBottom: "الانتقال للأسفل.",
                current: "الصفحة الحالية.",
                forceIframe: "إجبار دمج الصفحة التالية",
                cancelForceIframe: "إلغاء الدمج الإجباري",
                configure: "إعدادات Pagetual",
                firstUpdate: "انقر هنا لتهيئة القائمة الافتراضية للقواعد",
                update: "تحديث القواعد عبر الإنترنت",
                click2update: "انقر لتحديث القواعد من الرابط الآن",
                loadNow: "تحميل الصفحة التالية تلقائياً",
                loadConfirm: "كم عدد الصفحات التي تريد تحميلها؟ (0 تعني عدد لا نهائي)",
                noNext: "لم يتم العثور على رابط للصفحة التالية، يرجى إنشاء قاعدة جديدة",
                passSec: "تم التحديث قبل #t# ثانية/ثوانٍ",
                passMin: "تم التحديث قبل #t# دقيقة/دقائق",
                passHour: "تم التحديث قبل #t# ساعة/ساعات",
                passDay: "تم التحديث قبل #t# يوم/أيام",
                cantDel: "لا يمكن حذف القواعد الأساسية المدمجة",
                confirmDel: "هل أنت متأكد من رغبتك في حذف هذه القاعدة؟",
                updateSucc: "تم التحديث بنجاح",
                beginUpdate: "جاري التحديث، يرجى الانتظار لحظة...",
                customUrls: "استيراد روابط قواعد Pagetual أو AutoPagerize (رابط واحد في كل سطر).",
                customRules: "إدخال قواعد مخصصة. <a href='#t#'>✍️ المساهمة بقواعد</a>",
                save: "حفظ",
                loadingText: "جاري التحميل...",
                opacity: "الشفافية",
                opacityPlaceholder: "0: إخفاء الفاصل",
                hideBar: "إخفاء شريط الفاصل بين الصفحات",
                hideBarButNoStop: "إخفاء مع استمرار العمل",
                dbClick2Stop: "انقر نقراً مزدوجاً على أي مساحة فارغة للإيقاف المؤقت",
                sortTitle: "سيتم تطبيق الفرز بعد التحديث القادم للقواعد",
                autoRun: "تفعيل تلقائي (وضع القائمة السوداء)",
                autoLoadNum: "عدد الصفحات المراد تحميلها مسبقاً",
                turnRate: "تحميل الصفحة التالية عندما تكون المسافة المتبقية للأسفل أقل من 【X】 ضعف ارتفاع الصفحة",
                inputPageNum: "أدخل رقم الصفحة للانتقال إليها",
                enableHistory: "حفظ في سجل التصفح بعد الانتقال للصفحة التالية",
                enableHistoryAfterInsert: "حفظ في سجل التصفح فوراً بعد دمج الصفحة، وإلا سيتم الحفظ بعد التصفح",
                contentVisibility: "التبديل التلقائي لظهور المحتوى لتحسين أداء العرض",
                initRun: "تحميل الصفحات التالية فور فتح الموقع",
                preload: "التحميل المسبق للصفحة التالية لتسريع التصفح",
                click2ImportRule: "انقر لاستيراد رابط القواعد الأساسية، ثم انتظر حتى يكتمل التحديث: ",
                forceAllBody: "دمج محتوى الصفحة بالكامل؟",
                openInNewTab: "فتح الروابط الإضافية في علامة تبويب جديدة",
                importSucc: "اكتمل الاستيراد بنجاح",
                import: "استيراد",
                editCurrent: "تعديل قاعدة الموقع الحالي",
                editBlacklist: "تعديل القائمة السوداء للروابط (رابط واحد في كل سطر)، يدعم الرموز [*,?].",
                upBtnImg: "أيقونة العودة للأعلى",
                downBtnImg: "أيقونة الانتقال للأسفل",
                sideControllerIcon: "أيقونة الشريط الجانبي",
                loadingTextTitle: "جاري التحميل",
                dbClick2StopCtrl: "مفتاح Ctrl",
                dbClick2StopAlt: "مفتاح Alt",
                dbClick2StopShift: "مفتاح Shift",
                dbClick2StopMeta: "مفتاح Meta",
                dbClick2StopKey: "مفتاح الاختصار",
                pageElementCss: "تنسيق (CSS) مخصص للعناصر الأساسية بالصفحة",
                customCss: "كود CSS كامل ومخصص",
                firstAlert: "لم تقم باستيراد القاعدة الأساسية، يرجى تحديد القاعدة المناسبة لاستيرادها",
                picker: "أداة تحديد عناصر Pagetual",
                closePicker: "إغلاق أداة التحديد",
                pickerPlaceholder: "محدد العناصر (للمستخدمين المتقدمين فقط، وإلا اتركه فارغاً)",
                pickerCheck: "فحص المحدد ونسخه",
                switchSelector: "انقر لتبديل العنصر",
                gotoEdit: "الذهاب لتعديل القاعدة باستخدام المحدد الحالي",
                manualMode: "تعطيل الدمج التلقائي، والانتقال يدوياً للصفحة التالية باستخدام السهم الأيمن (أو إرسال حدث 'pagetual.next')",
                clickMode: "تعطيل الدمج التلقائي، والنقر تلقائياً على الصفحة التالية عند التمرير لنهاية الصفحة",
                pageBarMenu: "انقر في منتصف شريط الصفحة لفتح قائمة التحديد",
                nextSwitch: "تبديل الرابط التالي",
                arrowToScroll: "اضغط السهم الأيسر للرجوع والسهم الأيمن للتقدم في الصفحات",
                sideController: "عرض شريط التحكم بالصفحات في الشريط الجانبي",
                sideControllerScroll: "إظهار عند التمرير",
                sideControllerAlways: "إظهار دائماً",
                hideLoadingIcon: "إخفاء تأثير التحميل",
                hideBarArrow: "إخفاء أسهم شريط الصفحات",
                duplicate: "تم تثبيت نسخة مكررة من Pagetual، يرجى التحقق من مدير السكربتات لديك!",
                forceStateIframe: "تضمين الصفحة بالكامل كإطار (iframe)",
                forceStateDynamic: "تحميل المحتوى الديناميكي عبر إطار (iframe)",
                forceStateDisable: "تعطيل التقليب التلقائي في هذا الموقع",
                autoScrollRate: "سرعة التمرير (1~1000)",
                disableAutoScroll: "إيقاف التمرير التلقائي",
                enableAutoScroll: "تفعيل التمرير التلقائي",
                toggleAutoScroll: "تشغيل/إيقاف التمرير التلقائي",
                ruleRequest: "طلب قاعدة جديدة",
                page: "صفحة ",
                prevPage: "الصفحة السابقة",
                nextPage: "الصفحة التالية",
                errorRulesMustBeArray: "يجب أن تكون القواعد في شكل مصفوفة (Array)!",
                errorJson: "خطأ في صيغة JSON، تحقق منها مجدداً!",
                editSuccess: "تم التعديل بنجاح",
                errorWrongUrl: "الرابط غير صحيح، تحقق منه مجدداً!",
                errorAlreadyExists: "توجد قاعدة مسبقاً!",
                settingsSaved: "تم حفظ الإعدادات، قم بتحديث الصفحة لرؤيتها",
                iframe: "دمج إجباري عبر إطار (iframe)",
                dynamic: "تحميل ديناميكي",
                reloadPage: "اكتمل التعديل، هل تريد إعادة تحميل الصفحة الآن؟",
                copied: "تم النسخ",
                noValidContent: "لم يتم اكتشاف محتوى صالح، ربما يوجد اختبار تحقق (Captcha)",
                outOfDate: "السكربت قديم، يرجى التحديث إلى أحدث إصدار.",
                hideBarTips: "إخفاء شريط الصفحات لتجربة قراءة غامرة (بدون تشتيت)",
                setConfigPage: "تعيين الصفحة الحالية كصفحة الإعدادات الافتراضية",
                wedata2github: "تغيير مسار wedata إلى المسار البديل في مستودع Github",
                addOtherProp: "إضافة خصائص للقاعدة",
                ...
                customFirst: "تجاهل الذاكرة المؤقتة (Cache) للقواعد المحلية المخصصة",
                rulesExample: "أمثلة على القواعد",
                lastPage: "وصلت إلى الصفحة الأخيرة",
                lastPageTips: "إظهار تلميحات عند الوصول للصفحة الأخيرة"
            }
        },
        {
            name: "简体中文",
