...
(function() {
    ...
    function initRules(callback) {
        ...
        ruleParser.initSavedRules(()=>{
            storage.getItem("rulesData", data=>{
                ...
                if(rulesData.upBtnImg){
                    upSvg=`<img src="${rulesData.upBtnImg}"/>`;
                }
                if(rulesData.downBtnImg){
                    downSvg=`<img src="${rulesData.downBtnImg}"/>`;
                }
    ...
    function nextPage(){
        ...
        if(insert){
            ...
            if(!isJs)lastActiveUrl=nextLink;
