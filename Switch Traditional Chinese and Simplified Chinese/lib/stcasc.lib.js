...
export const OutputFormat = {
    ...
    RUBY: 2         // 输出 <ruby>简<rt>繁</rt></ruby> 格式
};
...
const sc2tc = {
    ...
    '干':[
        ...
        ['干','干系','天干','干涉','干扰','干戈','相干','干你什么','干你事','干你的事','干他什么','干他事','干他的事','干她什么','干她事','干她的事']
    ],
    '了':[
        '了',
                ...
                if (search.end) {
                    ...
                    if (format === OutputFormat.NORMAL) {
                        ...
                        if (format === OutputFormat.BRACKET && originalText !== convertedText) {
                            ...
                            str += '<ruby>' + convertedText + '<rt>' + originalText + '</rt></ruby>';
                        } else {
                            str += convertedText;
                        }
                    }
        ...
        if (char.charCodeAt(0) > 10000) {
            ...
            if (tChar || sc2tcItem) {
                ...
                if (format === OutputFormat.BRACKET && char !== newChar) {
                    ...
                    str += '<ruby>' + newChar + '<rt>' + char + '</rt></ruby>';
                } else {
                    str += newChar;
                }
            } else str += char;
